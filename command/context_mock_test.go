...
// MockGitHubContext is a mock of GitHubContext interface
type MockGitHubContext struct {
	ctrl     *gomock.Controller
	recorder *MockGitHubContextMockRecorder
}

// MockGitHubContextMockRecorder is the mock recorder for MockGitHubContext
type MockGitHubContextMockRecorder struct {
	mock *MockGitHubContext
}

// NewMockGitHubContext creates a new mock instance
func NewMockGitHubContext(ctrl *gomock.Controller) *MockGitHubContext {
	mock := &MockGitHubContext{ctrl: ctrl}
	mock.recorder = &MockGitHubContextMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockGitHubContext) EXPECT() *MockGitHubContextMockRecorder {
	return m.recorder
}

// GitHubUser mocks base method
func (m *MockGitHubContext) GitHubUser() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GitHubUser")
	ret0, _ := ret[0].(string)
	return ret0
...
// GitHubUser indicates an expected call of GitHubUser
func (mr *MockGitHubContextMockRecorder) GitHubUser() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GitHubUser", reflect.TypeOf((*MockGitHubContext)(nil).GitHubUser))
}

// GitHubToken mocks base method
func (m *MockGitHubContext) GitHubToken() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GitHubToken")
	ret0, _ := ret[0].(string)
	return ret0
...
// GitHubToken indicates an expected call of GitHubToken
func (mr *MockGitHubContextMockRecorder) GitHubToken() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GitHubToken", reflect.TypeOf((*MockGitHubContext)(nil).GitHubToken))
}

// GitHubHost mocks base method
func (m *MockGitHubContext) GitHubHost() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GitHubHost")
	ret0, _ := ret[0].(string)
	return ret0
...
// GitHubHost indicates an expected call of GitHubHost
func (mr *MockGitHubContextMockRecorder) GitHubHost() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GitHubHost", reflect.TypeOf((*MockGitHubContext)(nil).GitHubHost))
}
