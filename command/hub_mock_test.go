...
func (m *MockHubClient) Repos(arg0 context.Context, arg1 gogh.Env, arg2 string, arg3, arg4, arg5 bool, arg6, arg7, arg8 string) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Repos", arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockHubClientMockRecorder) Repos(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Repos", reflect.TypeOf((*MockHubClient)(nil).Repos), arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
}
