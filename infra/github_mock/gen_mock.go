...
// Source: ./infra/github/if.go
//
// Generated by this command:
//
//	mockgen -source ./infra/github/if.go -destination ./infra/github_mock/gen_mock.go -package github_mock
//
...
import (
	...
	github "github.com/kyoh86/gogh/v3/infra/github"
...
func (m *MockAdaptor) GetAccessToken() (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) GetAccessToken() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccessToken", reflect.TypeOf((*MockAdaptor)(nil).GetAccessToken))
}
...
func (mr *MockAdaptorMockRecorder) GetAuthenticatedUser(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) GetMe(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) RepositoryCreate(ctx, org, repo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) RepositoryCreateFork(ctx, owner, repo, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) RepositoryCreateFromTemplate(ctx, templateOwner, templateRepo, templateRepoReq any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) RepositoryDelete(ctx, owner, repo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) RepositoryGet(ctx, owner, repo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) RepositoryList(ctx, opts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAdaptorMockRecorder) UserGet(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
