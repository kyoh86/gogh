...
// LayoutService defines the layout structure of a repository under a root directory
type LayoutService interface {
	...
	ListRepository(_ context.Context, limit int) iter.Seq2[Repository, error]
